...
<?php 
	...
	if($_GET['edit_id']){
		...
		header('location: products.php?success=false&msg=Requested record not found !');
	}
    ...
    if(isset($_FILES['uploadImage']) && !empty($_FILES['uploadImage']['name'])){
        ...
        if($response['success'] == true){
            ...
            SET category_id = $category_id, product_name = '$name', product_code = '$code', product_price = '$price', product_desc = '$descNicEdit', image_1 = '$imagePath', product_status = $status
            WHERE id = $edit_id ";
            $isQueryValid = true;
        }
    }else{//if not updating 
            $query = "UPDATE products 
            SET category_id = $category_id, product_name = '$name', product_code = '$code', product_price = '$price', product_desc = '$descNicEdit', product_status = $status
            WHERE id = $edit_id ";
            $isQueryValid = true;
    }
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">	
		<div class="row">
			<ol class="breadcrumb top-bar-margin">
				<li><a href="products.php"><span class="glyphicon glyphicon-leaf"></span> </a></li>
		...
		<div class="panel panel-warning">
	  	<div class="panel-heading">
	  		<h3><span class="glyphicon glyphicon-leaf"></span> Edit Product</h3>
	  			...
	  			<form action="" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            ...
                            <div class="col-sm-4">
                                <img  class="small_img" src="../productImage/<?=$edit['image_1'] ?>" alt="">
                            </div>
                            </div>
                        </div>
                    </div>
