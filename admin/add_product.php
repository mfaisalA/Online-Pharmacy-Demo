...
<?php 
    ...
    if(isset($_FILES['uploadImage']) && !empty($_FILES['uploadImage']['name'])){
        ...
        if($response['success'] == true){
            ...
            $query = "INSERT INTO products (category_id, product_name, product_code, product_price, product_desc, image_1, product_status, created_date) 
            VALUES($category_id, '$name', '$code', '$price', '$descNicEdit', '$imagePath', $status, NOW()) ";
            $isQueryValid = true;
        }
    }
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">	
		...
		<div class="panel panel-warning">
	  	<div class="panel-heading">
	  		<h3><span class="glyphicon glyphicon-leaf"></span> Add Product</h3>
