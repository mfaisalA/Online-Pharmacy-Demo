	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">	
		...
		<div class="panel panel-warning">
	  	<div class="panel-heading">
	  		<a href="add_product.php" class="btn btn-primary pull-right" style="margin: 10px"><span class="glyphicon glyphicon-plus"> Add Product</span></a>
	  		<h3><span class="glyphicon glyphicon-leaf"></span> Products List</h3>
  				...
  				<?php
					...
					while ($row = mysqli_fetch_assoc($rs)){?>
		  			...
		  			<tr>
						...
						<td><img class="small_img" src="../productImage/<?=$row['image_1'] ?>" alt=""></td>

						<td><?=ucfirst(getCategoryNameFromId($con, $row['category_id'])) ?></td>
						<td><?=$row['product_status'] ? 'Active' : 'In-Active' ?></td>
						<td>
						<ul class="list-inline">
							<li>
								<a href="edit_product.php?edit_id=<?=$row['id'] ?>" class="btn btn-warning btn-xs"><span class="glyphicon glyphicon-pencil"></span></a>
							</li>
							<li>
